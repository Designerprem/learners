...
const FacultyPortalLayout = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            const firstUnseenPopup = facultyAnnouncements.find(ann => !seenPopups.includes(ann.id));
            if (firstUnseenPopup) {
            ...
            console.error("Failed to process announcements for faculty:", error);
        }
    }, [facultyMember]);
...
export function useFaculty() {
    return useOutletContext<{ facultyMember: FacultyMember }>();
}
