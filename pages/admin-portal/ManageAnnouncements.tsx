...
const ManageAnnouncements: React.FC = () => {
    const [announcements, setAnnouncements] = useState<Announcement[]>(GLOBAL_ANNOUNCEMENTS);
    ...
    const handleCreateAnnouncement = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const newAnnouncement: Announcement = {
            ...
            audience: formData.get('audience') as 'All Students' | 'All Faculty',
            author: 'Admin',
        ...
        <div>
            ...
            {isCreating && (
                <div className="bg-white p-6 rounded-lg shadow-md mb-8">
                    <h2 className="text-2xl font-bold text-brand-dark mb-4">New Global Announcement</h2>
