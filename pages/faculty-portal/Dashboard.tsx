...
import { STUDENTS, LIVE_CLASSES, TEACHER_QUESTIONS, MOCK_TESTS, STUDENT_SUBMISSIONS, CALENDAR_EVENTS } from '../../constants';
import { useFaculty } from '../FacultyPortalPage';
import { getItems, saveItems } from '../../services/dataService';
import type { TeacherQuestion, MockTest, StudentSubmission, Student, CalendarEvent, LiveClass } from '../../types';
