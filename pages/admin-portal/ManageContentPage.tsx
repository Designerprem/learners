...
import { HERO_SLIDES, GALLERY_IMAGES, VLOGS, BLOG_POSTS, NEWS_TICKER_MESSAGES, FACULTY_MEMBERS, POPUP_NOTIFICATION, STUDENTS, TESTIMONIALS, HIGH_ACHIEVERS, DEFAULT_CONTACT_DETAILS } from '../../constants';
import type { HeroSlide, GalleryImage, Vlog, BlogPost, PopupNotification, Testimonial, Student, FacultyMember, HighAchiever, ContactDetails, SocialMediaLink } from '../../types';
import { compressImage, imageFileToDataUrl } from '../../services/imageCompressionService';

type Tab = 'Banners' | 'Gallery' | 'Vlogs' | 'Blogs' | 'News Ticker' | 'Popup' | 'Testimonials' | 'High Achievers' | 'Contact & Socials';
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="border-b border-gray-200 mb-6 overflow-x-auto">
                    <nav className="-mb-px flex space-x-4 sm:space-x-8" aria-label="Tabs">
                        {(['Banners', 'Gallery', 'Vlogs', 'Blogs', 'News Ticker', 'Popup', 'Testimonials', 'High Achievers', 'Contact & Socials'] as Tab[]).map(tab => (
                            <button
                                key={tab}
